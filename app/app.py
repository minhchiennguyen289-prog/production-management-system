...
#    Fixed: validates inputs before calling procedure
# ============================================================
...
# ============================================================
# 8. REPORTING MODULE
#    Daily / Weekly / Monthly production & stock reports
# ============================================================

def _print_production_report(conn, start_date: str, end_date: str, label: str):
    """Internal helper: calls GetProductionReport stored procedure."""
    cursor = conn.cursor()
...
def report_weekly(conn):
    today = date.today()
    start = (today - timedelta(days=today.weekday())).strftime("%Y-%m-%d")  # Monday
...
def main_menu():
    ...
    while True:
        ...
        print("  --- REPORTS ---")
        print("  7. Reporting Module (Daily / Weekly / Monthly)")
        print("  --- SYSTEM ---")
        print("  8. Exit System")
        print("="*50)
        ...
        elif choice == '7': reporting_menu(conn)
        elif choice == '8':
